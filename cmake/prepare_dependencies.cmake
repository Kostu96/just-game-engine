...
message(STATUS "Preparing glad...")
execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/dependencies/glad/build OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} -S ${PROJECT_SOURCE_DIR}/engine/third_party/glad -B ${PROJECT_BINARY_DIR}/dependencies/glad/build OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/dependencies/glad/install OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR}/dependencies/glad/build --config Debug --prefix "${PROJECT_BINARY_DIR}/dependencies/glad/install" OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR}/dependencies/glad/build --config Release --prefix "${PROJECT_BINARY_DIR}/dependencies/glad/install" OUTPUT_QUIET)
set(glad_DIR ${PROJECT_BINARY_DIR}/dependencies/glad/install/lib/cmake/glad)
...
message(STATUS "Preparing stb...")
execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/dependencies/stb/build OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} -S ${PROJECT_SOURCE_DIR}/engine/third_party/stb -B ${PROJECT_BINARY_DIR}/dependencies/stb/build OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/dependencies/stb/install OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR}/dependencies/stb/build --config Debug --prefix "${PROJECT_BINARY_DIR}/dependencies/stb/install" OUTPUT_QUIET)
execute_process(COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR}/dependencies/stb/build --config Release --prefix "${PROJECT_BINARY_DIR}/dependencies/stb/install" OUTPUT_QUIET)
set(stb_DIR ${PROJECT_BINARY_DIR}/dependencies/stb/install/lib/cmake/stb)
